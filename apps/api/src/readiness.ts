...
export function buildReadinessSnapshot(env: EnvLike = process.env) {
  ...
  return {
    ...
    providerReadiness: {
      ...
      reviewExportRedactionAuditEnabled: webhookGuardrails.reviewExportRedactionAuditEnabled,
      reviewExportIntegrityChecksEnabled: webhookGuardrails.reviewExportIntegrityChecksEnabled,
      reviewExportManifestEnabled: webhookGuardrails.reviewExportManifestEnabled,
      reviewExportQaHandoffEnabled: webhookGuardrails.reviewExportQaHandoffEnabled,
      reviewQaHandoffLockedArchiveEnabled: webhookGuardrails.reviewQaHandoffLockedArchiveEnabled,
      reviewQaHandoffRetentionManifestEnabled: webhookGuardrails.reviewQaHandoffRetentionManifestEnabled,
      lockedArchiveReadyCount: webhookGuardrails.lockedArchiveReadyCount,
      lockedArchiveExportedCount: webhookGuardrails.lockedArchiveExportedCount,
      retentionManifestReadyCount: webhookGuardrails.retentionManifestReadyCount,
      latestLockedArchiveStatus: webhookGuardrails.latestLockedArchiveStatus,
      latestRetentionManifestStatus: webhookGuardrails.latestRetentionManifestStatus,
      exportRedactionPassedCount: webhookGuardrails.exportRedactionPassedCount,
      exportRedactionWarningCount: webhookGuardrails.exportRedactionWarningCount,
      exportRedactionBlockedCount: webhookGuardrails.exportRedactionBlockedCount,
      exportManifestReadyCount: webhookGuardrails.exportManifestReadyCount,
      exportManifestNeedsReviewCount: webhookGuardrails.exportManifestNeedsReviewCount,
      exportManifestBlockedCount: webhookGuardrails.exportManifestBlockedCount,
      latestExportManifestStatus: webhookGuardrails.latestExportManifestStatus,
