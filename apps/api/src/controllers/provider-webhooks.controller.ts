...
export class ProviderWebhooksController {
  ...
  @Get("review-qa-handoff-bundle/locked-archive/finalization/release-evidence/verification/certification/closure-ledger/attestation-audit/reconciliation/release-gate/decision-receipt/handoff-packet/acceptance-record/noop-execution-dryrun/result-ledger")
  getReviewQaHandoffCertifiedReleaseDryRunResultLedger(
    @Headers("x-tenant-id") tenant: string | undefined,
    @Query() query: unknown,
    @Headers("x-user-id") userId?: string
  ) {
    return this.events.getReviewQaHandoffCertifiedReleaseDryRunResultLedger(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }

  @Get("review-qa-handoff-bundle/locked-archive/finalization/release-evidence/verification/certification/closure-ledger/attestation-audit/reconciliation/release-gate/decision-receipt/handoff-packet/acceptance-record/noop-execution-dryrun/result-ledger/final-readiness-certificate")
  getReviewQaHandoffCertifiedReleaseFinalReadinessCertificate(
    @Headers("x-tenant-id") tenant: string | undefined,
    @Query() query: unknown,
    @Headers("x-user-id") userId?: string
  ) {
    return this.events.getReviewQaHandoffCertifiedReleaseFinalReadinessCertificate(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }

  @Get("review-qa-handoff-bundle/locked-archive/finalization/release-evidence/verification/certification/closure-ledger/attestation-audit/reconciliation/release-gate/decision-receipt/handoff-packet/acceptance-record/noop-execution-dryrun/result-ledger/final-readiness-certificate/freeze-audit-register")
  getReviewQaHandoffCertifiedReleaseFreezeAuditRegister(
    @Headers("x-tenant-id") tenant: string | undefined,
    @Query() query: unknown,
    @Headers("x-user-id") userId?: string
  ) {
    return this.events.getReviewQaHandoffCertifiedReleaseFreezeAuditRegister(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseRollbackRehearsalReceipt(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseRollbackRehearsalReceipt(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseControlRoomPacket(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseControlRoomPacket(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseCutoverChecklistReceipt(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseCutoverChecklistReceipt(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseOperatorCommandReceipt(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseOperatorCommandReceipt(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseGoLiveAuthorizationReceipt(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseGoLiveAuthorizationReceipt(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseLaunchWindowConfirmationReceipt(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseLaunchWindowConfirmationReceipt(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseGoLiveHoldReleaseAuthorizationReceipt(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseGoLiveHoldReleaseAuthorizationReceipt(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseLaunchApprovalReceipt(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseLaunchApprovalReceipt(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }

  @Get("review-qa-handoff-bundle/locked-archive/finalization/release-evidence/verification/certification/closure-ledger/attestation-audit/reconciliation/release-gate/decision-receipt/handoff-packet/acceptance-record/noop-execution-dryrun/result-ledger/final-readiness-certificate/freeze-audit-register/rollback-rehearsal-receipt/control-room-packet/cutover-checklist-receipt/operator-command-receipt/go-live-authorization-receipt/launch-window-confirmation-receipt/go-live-hold-release-authorization-receipt/launch-approval-receipt/no-execution-lock-receipt")
  getReviewQaHandoffCertifiedReleaseNoExecutionLockReceipt(
    @Headers("x-tenant-id") tenant: string | undefined,
    @Query() query: unknown,
    @Headers("x-user-id") userId?: string
  ) {
    return this.events.getReviewQaHandoffCertifiedReleaseNoExecutionLockReceipt(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseOperationsHandoffReadinessPacket(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseOperationsHandoffReadinessPacket(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseOperationsHandoffAcceptanceReceipt(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseOperationsHandoffAcceptanceReceipt(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseOperationsCustodyMonitoringReadinessLedger(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseOperationsCustodyMonitoringReadinessLedger(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseOperationsCustodyMonitoringCloseoutSealReceipt(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseOperationsCustodyMonitoringCloseoutSealReceipt(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseFinalNoExecutionEvidenceRollup(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseFinalNoExecutionEvidenceRollup(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseFinalEvidenceIndexRegressionGuardrailReceipt(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseFinalEvidenceIndexRegressionGuardrailReceipt(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationContinuityLedgerReceipt(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationContinuityLedgerReceipt(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyAuditReceipt(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyAuditReceipt(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainSealReceipt(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainSealReceipt(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainIntegrityLedgerReceipt(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainIntegrityLedgerReceipt(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainIntegrityLedgerContinuityReceipt(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainIntegrityLedgerContinuityReceipt(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationReceipt(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationReceipt(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationAuditReceipt(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationAuditReceipt(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationAuditReconciliationReceipt(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationAuditReconciliationReceipt(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationAuditReconciliationAcceptanceReceipt(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationAuditReconciliationAcceptanceReceipt(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
  ...
  getReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationAuditReconciliationAcceptanceContinuitySealReceipt(
    ...
    return this.events.getReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationAuditReconciliationAcceptanceContinuitySealReceipt(requireTenantId(tenant), parseReviewClosureReportFilters(query), userId);
  }
