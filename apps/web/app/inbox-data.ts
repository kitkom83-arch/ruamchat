import type { ConversationFilter, ConversationPriority, ConversationStatus, CoreConversationCard, CoreMessage, CoreRoom, DataMode, KnowledgeItem, SlaStatus } from "@ai-omni/shared";
