...
describe("frontend API client", () => {
  ...
  it("wires archive finalization, retention sign-off, and receipt through tenant-scoped API calls without fallback", async () => {
    const fetchMock = vi.spyOn(globalThis, "fetch")
      ...
      .mockResolvedValueOnce(jsonResponse(providerWebhookArchiveCertifiedReleaseFinalEvidenceIndexRegressionGuardrailReceiptResponse()))
      .mockResolvedValueOnce(jsonResponse(providerWebhookArchiveCertifiedReleaseFinalArchiveSealOperationalClosureReceiptResponse()))
      .mockResolvedValueOnce(jsonResponse(providerWebhookArchiveCertifiedReleaseFinalArchiveSealPostClosurePreservationVerificationReceiptResponse()))
      .mockResolvedValueOnce(jsonResponse(providerWebhookArchiveCertifiedReleaseFinalArchiveSealPostClosurePreservationContinuityLedgerReceiptResponse()))
      .mockResolvedValueOnce(jsonResponse(providerWebhookArchiveCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyAuditReceiptResponse()))
      .mockResolvedValueOnce(jsonResponse(providerWebhookArchiveCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainSealReceiptResponse()))
      .mockResolvedValueOnce(jsonResponse(providerWebhookArchiveCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainIntegrityLedgerReceiptResponse()))
      .mockResolvedValueOnce(jsonResponse(providerWebhookArchiveCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainIntegrityLedgerContinuityReceiptResponse()))
      .mockResolvedValueOnce(jsonResponse(providerWebhookArchiveCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationReceiptResponse()))
      .mockResolvedValueOnce(jsonResponse(providerWebhookArchiveCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationAuditReceiptResponse()));
    ...
    const finalEvidenceIndexRegressionGuardrailReceipt = await getProviderWebhookReviewQaHandoffCertifiedReleaseFinalEvidenceIndexRegressionGuardrailReceipt(filters);
    const finalArchiveSealOperationalClosureReceipt = await getProviderWebhookReviewQaHandoffCertifiedReleaseFinalArchiveSealOperationalClosureReceipt(filters);
    const postClosurePreservationVerificationReceipt = await getProviderWebhookReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationVerificationReceipt(filters);
    const postClosurePreservationContinuityLedgerReceipt = await getProviderWebhookReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationContinuityLedgerReceipt(filters);
    const postClosurePreservationCustodyAuditReceipt = await getProviderWebhookReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyAuditReceipt(filters);
    const postClosurePreservationCustodyChainSealReceipt = await getProviderWebhookReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainSealReceipt(filters);
    const postClosurePreservationCustodyChainIntegrityLedgerReceipt = await getProviderWebhookReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainIntegrityLedgerReceipt(filters);
    const postClosurePreservationCustodyChainIntegrityLedgerContinuityReceipt = await getProviderWebhookReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainIntegrityLedgerContinuityReceipt(filters);
    const postClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationReceipt = await getProviderWebhookReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationReceipt(filters);
    const postClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationAuditReceipt = await getProviderWebhookReviewQaHandoffCertifiedReleaseFinalArchiveSealPostClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationAuditReceipt(filters);
    ...
    expect(fetchMock).toHaveBeenCalledWith("http://localhost:4000/provider-webhooks/review-qa-handoff-bundle/locked-archive/finalization/release-evidence/verification/certification/closure-ledger/attestation-audit/reconciliation/release-gate/decision-receipt/handoff-packet/acceptance-record/noop-execution-dryrun/result-ledger/final-readiness-certificate/freeze-audit-register/rollback-rehearsal-receipt/control-room-packet/cutover-checklist-receipt/operator-command-receipt/go-live-authorization-receipt/launch-window-confirmation-receipt/go-live-hold-release-authorization-receipt/launch-approval-receipt/no-execution-lock-receipt/operations-handoff-readiness-no-execution-evidence-packet/operations-handoff-acceptance-receipt/operations-custody-monitoring-readiness-ledger/operations-custody-monitoring-closeout-seal-receipt/final-no-execution-evidence-rollup/final-evidence-index-regression-guardrail-receipt?provider=line&eventType=message.created", expect.any(Object));
    expect(fetchMock).toHaveBeenCalledWith("http://localhost:4000/provider-webhooks/review-qa-handoff-bundle/locked-archive/finalization/release-evidence/verification/certification/closure-ledger/attestation-audit/reconciliation/release-gate/decision-receipt/handoff-packet/acceptance-record/noop-execution-dryrun/result-ledger/final-readiness-certificate/freeze-audit-register/rollback-rehearsal-receipt/control-room-packet/cutover-checklist-receipt/operator-command-receipt/go-live-authorization-receipt/launch-window-confirmation-receipt/go-live-hold-release-authorization-receipt/launch-approval-receipt/no-execution-lock-receipt/operations-handoff-readiness-no-execution-evidence-packet/operations-handoff-acceptance-receipt/operations-custody-monitoring-readiness-ledger/operations-custody-monitoring-closeout-seal-receipt/final-no-execution-evidence-rollup/final-evidence-index-regression-guardrail-receipt/final-archive-seal-operational-closure-receipt?provider=line&eventType=message.created", expect.any(Object));
    expect(fetchMock).toHaveBeenCalledWith("http://localhost:4000/provider-webhooks/review-qa-handoff-bundle/locked-archive/finalization/release-evidence/verification/certification/closure-ledger/attestation-audit/reconciliation/release-gate/decision-receipt/handoff-packet/acceptance-record/noop-execution-dryrun/result-ledger/final-readiness-certificate/freeze-audit-register/rollback-rehearsal-receipt/control-room-packet/cutover-checklist-receipt/operator-command-receipt/go-live-authorization-receipt/launch-window-confirmation-receipt/go-live-hold-release-authorization-receipt/launch-approval-receipt/no-execution-lock-receipt/operations-handoff-readiness-no-execution-evidence-packet/operations-handoff-acceptance-receipt/operations-custody-monitoring-readiness-ledger/operations-custody-monitoring-closeout-seal-receipt/final-no-execution-evidence-rollup/final-evidence-index-regression-guardrail-receipt/final-archive-seal-operational-closure-receipt/post-closure-preservation-verification-receipt?provider=line&eventType=message.created", expect.any(Object));
    expect(fetchMock).toHaveBeenCalledWith("http://localhost:4000/provider-webhooks/review-qa-handoff-bundle/locked-archive/finalization/release-evidence/verification/certification/closure-ledger/attestation-audit/reconciliation/release-gate/decision-receipt/handoff-packet/acceptance-record/noop-execution-dryrun/result-ledger/final-readiness-certificate/freeze-audit-register/rollback-rehearsal-receipt/control-room-packet/cutover-checklist-receipt/operator-command-receipt/go-live-authorization-receipt/launch-window-confirmation-receipt/go-live-hold-release-authorization-receipt/launch-approval-receipt/no-execution-lock-receipt/operations-handoff-readiness-no-execution-evidence-packet/operations-handoff-acceptance-receipt/operations-custody-monitoring-readiness-ledger/operations-custody-monitoring-closeout-seal-receipt/final-no-execution-evidence-rollup/final-evidence-index-regression-guardrail-receipt/final-archive-seal-operational-closure-receipt/post-closure-preservation-verification-receipt/post-closure-preservation-continuity-ledger-receipt?provider=line&eventType=message.created", expect.any(Object));
    expect(fetchMock).toHaveBeenCalledWith("http://localhost:4000/provider-webhooks/review-qa-handoff-bundle/locked-archive/finalization/release-evidence/verification/certification/closure-ledger/attestation-audit/reconciliation/release-gate/decision-receipt/handoff-packet/acceptance-record/noop-execution-dryrun/result-ledger/final-readiness-certificate/freeze-audit-register/rollback-rehearsal-receipt/control-room-packet/cutover-checklist-receipt/operator-command-receipt/go-live-authorization-receipt/launch-window-confirmation-receipt/go-live-hold-release-authorization-receipt/launch-approval-receipt/no-execution-lock-receipt/operations-handoff-readiness-no-execution-evidence-packet/operations-handoff-acceptance-receipt/operations-custody-monitoring-readiness-ledger/operations-custody-monitoring-closeout-seal-receipt/final-no-execution-evidence-rollup/final-evidence-index-regression-guardrail-receipt/final-archive-seal-operational-closure-receipt/post-closure-preservation-verification-receipt/post-closure-preservation-continuity-ledger-receipt/post-closure-preservation-custody-audit-receipt?provider=line&eventType=message.created", expect.any(Object));
    ...
    expect(launchApprovalReceipt.launchApprovalReceiptStatus).toBe("issued");
    expect(launchApprovalReceipt.noExecutionGuardStatus).toBe("retained");
    expect(launchApprovalReceipt.launchApprovalStatus).toBe("ready");
    expect(launchApprovalReceipt.externalCalls).toBe(0);
    expect(noExecutionLockReceipt.noExecutionLockReceiptStatus).toBe("issued");
    expect(noExecutionLockReceipt.noExecutionLockStatus).toBe("locked");
    ...
    expect(operationsCustodyMonitoringReadinessLedger.operationsCustodyMonitoringStatus).toBe("ready");
    expect(operationsCustodyMonitoringReadinessLedger.monitoringReadinessStatus).toBe("ready");
    expect(operationsCustodyMonitoringReadinessLedger.noExecutionMonitoringStatus).toBe("active");
    expect(operationsCustodyMonitoringReadinessLedger.externalCalls).toBe(0);
    expect(operationsCustodyMonitoringCloseoutSealReceipt.operationsCustodyMonitoringCloseoutStatus).toBe("sealed");
    expect(operationsCustodyMonitoringCloseoutSealReceipt.closeoutSealStatus).toBe("sealed");
    ...
    expect(finalEvidenceIndexRegressionGuardrailReceipt.finalEvidenceIndexStatus).toBe("issued");
    expect(finalEvidenceIndexRegressionGuardrailReceipt.regressionGuardrailReceiptStatus).toBe("issued");
    expect(finalEvidenceIndexRegressionGuardrailReceipt.finalNoExecutionEvidenceRollupStatus).toBe("issued");
    expect(finalEvidenceIndexRegressionGuardrailReceipt.finalArchiveCustodyStatus).toBe("sealed");
    expect(finalEvidenceIndexRegressionGuardrailReceipt.operationsCustodyMonitoringCloseoutStatus).toBe("sealed");
    expect(finalEvidenceIndexRegressionGuardrailReceipt.closeoutSealStatus).toBe("sealed");
    expect(finalEvidenceIndexRegressionGuardrailReceipt.regressionGuardrailStatus).toBe("passed");
    expect(finalEvidenceIndexRegressionGuardrailReceipt.tenantScopeStatus).toBe("tenant_scoped");
    expect(finalEvidenceIndexRegressionGuardrailReceipt.digestContinuityStatus).toBe("confirmed");
    expect(finalEvidenceIndexRegressionGuardrailReceipt.externalCalls).toBe(0);
    ...
    expect(finalEvidenceIndexRegressionGuardrailReceipt.finalEvidenceIndexRows.map((row) => row.sprintNumber)).toEqual([103, 104, 105, 106, 107, 108, 109, 110]);
    expect(finalArchiveSealOperationalClosureReceipt.finalOperationalClosureReceiptStatus).toBe("issued");
    expect(finalArchiveSealOperationalClosureReceipt.finalArchiveSealStatus).toBe("sealed");
    expect(finalArchiveSealOperationalClosureReceipt.releaseClosureStatus).toBe("closed");
    expect(finalArchiveSealOperationalClosureReceipt.finalEvidenceIndexStatus).toBe("issued");
    expect(finalArchiveSealOperationalClosureReceipt.regressionGuardrailReceiptStatus).toBe("issued");
    expect(finalArchiveSealOperationalClosureReceipt.regressionGuardrailStatus).toBe("passed");
    expect(finalArchiveSealOperationalClosureReceipt.tenantScopeStatus).toBe("tenant_scoped");
    expect(finalArchiveSealOperationalClosureReceipt.digestContinuityStatus).toBe("confirmed");
    expect(finalArchiveSealOperationalClosureReceipt.externalCalls).toBe(0);
    ...
    expect(finalArchiveSealOperationalClosureReceipt.finalArchiveSealOperationalClosureRows.map((row) => row.sprintNumber)).toEqual([103, 104, 105, 106, 107, 108, 109, 110, 111]);
    expect(postClosurePreservationVerificationReceipt.postClosurePreservationVerificationStatus).toBe("verified");
    expect(postClosurePreservationVerificationReceipt.finalArchiveSealPostClosurePreservationStatus).toBe("preserved");
    expect(postClosurePreservationVerificationReceipt.finalArchiveSealStatus).toBe("sealed");
    expect(postClosurePreservationVerificationReceipt.releaseClosureStatus).toBe("closed");
    expect(postClosurePreservationVerificationReceipt.externalCalls).toBe(0);
    ...
    expect(postClosurePreservationVerificationReceipt.postClosurePreservationVerificationRows.map((row) => row.sprintNumber)).toEqual([103, 104, 105, 106, 107, 108, 109, 110, 111, 112]);
    expect(postClosurePreservationContinuityLedgerReceipt.postClosurePreservationContinuityLedgerStatus).toBe("continuous");
    expect(postClosurePreservationContinuityLedgerReceipt.postClosurePreservationVerificationStatus).toBe("verified");
    ...
    expect(postClosurePreservationContinuityLedgerReceipt.externalCalls).toBe(0);
    ...
    expect(postClosurePreservationContinuityLedgerReceipt.preservationContinuityLedgerRows.map((row) => row.sprintNumber)).toEqual([103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113]);
    expect(postClosurePreservationCustodyAuditReceipt.postClosurePreservationCustodyAuditStatus).toBe("audited");
    expect(postClosurePreservationCustodyAuditReceipt.postClosurePreservationContinuityLedgerStatus).toBe("continuous");
    ...
    expect(postClosurePreservationCustodyAuditReceipt.externalCalls).toBe(0);
    ...
    expect(postClosurePreservationCustodyAuditReceipt.custodyAuditRows.map((row) => row.sprintNumber)).toEqual([103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114]);
    expect(postClosurePreservationCustodyChainSealReceipt.postClosurePreservationCustodyChainSealStatus).toBe("sealed");
    expect(postClosurePreservationCustodyChainSealReceipt.postClosurePreservationCustodyAuditStatus).toBe("audited");
    ...
    expect(postClosurePreservationCustodyChainSealReceipt.externalCalls).toBe(0);
    ...
    expect(postClosurePreservationCustodyChainSealReceipt.custodyChainSealRows.map((row) => row.sprintNumber)).toEqual([103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115]);
    expect(postClosurePreservationCustodyChainIntegrityLedgerReceipt.postClosurePreservationCustodyChainIntegrityLedgerStatus).toBe("integrity_confirmed");
    expect(postClosurePreservationCustodyChainIntegrityLedgerReceipt.postClosurePreservationCustodyChainSealStatus).toBe("sealed");
    ...
    expect(postClosurePreservationCustodyChainIntegrityLedgerReceipt.externalCalls).toBe(0);
    ...
    expect(postClosurePreservationCustodyChainIntegrityLedgerReceipt.custodyChainIntegrityLedgerRows.map((row) => row.sprintNumber)).toEqual([103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116]);
    expect(postClosurePreservationCustodyChainIntegrityLedgerContinuityReceipt.postClosurePreservationCustodyChainIntegrityLedgerContinuityStatus).toBe("continuity_confirmed");
    expect(postClosurePreservationCustodyChainIntegrityLedgerContinuityReceipt.postClosurePreservationCustodyChainIntegrityLedgerStatus).toBe("integrity_confirmed");
    expect(postClosurePreservationCustodyChainIntegrityLedgerContinuityReceipt.redactionStatus).toBe("passed");
    ...
    expect(postClosurePreservationCustodyChainIntegrityLedgerContinuityReceipt.externalCalls).toBe(0);
    ...
    expect(postClosurePreservationCustodyChainIntegrityLedgerContinuityReceipt.safeRowSummaries.map((row) => row.sprintNumber)).toEqual([103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117]);
    expect(postClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationReceipt.receiptStatus).toBe("issued");
    expect(postClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationReceipt.verificationStatus).toBe("verified");
    expect(postClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationReceipt.continuityStatus).toBe("continuity_confirmed");
    expect(postClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationReceipt.custodyChainStatus).toBe("sealed");
    expect(postClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationReceipt.ledgerIntegrityStatus).toBe("integrity_confirmed");
    expect(postClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationReceipt.noExecutionStatus).toBe("confirmed");
    expect(postClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationReceipt.sourceSprint).toBe(117);
    ...
    expect(postClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationReceipt.externalCalls).toBe(0);
    expect(postClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationReceipt.noExecutionFlags.providerOutboundCallCount).toBe(0);
    ...
    expect(postClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationReceipt.verificationRows.map((row) => row.sprintNumber)).toEqual([103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118]);
    expect(postClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationAuditReceipt.receiptStatus).toBe("issued");
    expect(postClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationAuditReceipt.auditStatus).toBe("audited");
    expect(postClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationAuditReceipt.verificationStatus).toBe("verified");
    expect(postClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationAuditReceipt.sourceSprint).toBe(118);
    ...
    expect(postClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationAuditReceipt.externalCalls).toBe(0);
    expect(postClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationAuditReceipt.noExecutionFlags.providerOutboundCallCount).toBe(0);
    ...
    expect(postClosurePreservationCustodyChainIntegrityLedgerContinuityVerificationAuditReceipt.auditRows.map((row) => row.sprintNumber)).toEqual([103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119]);
    ...
    expect(noExecutionLockReceipt.externalCalls).toBe(0);
    expect(operationsHandoffReadinessPacket.operationsHandoffReadinessStatus).toBe("ready_for_handoff");
    expect(operationsHandoffReadinessPacket.operationsHandoffEvidencePacketStatus).toBe("issued");
    expect(operationsHandoffReadinessPacket.noExecutionEvidenceStatus).toBe("confirmed");
    expect(operationsHandoffReadinessPacket.launchApprovalLockStatus).toBe("locked");
    expect(operationsHandoffReadinessPacket.digestContinuityStatus).toBe("confirmed");
  ...
  it("surfaces certified release operations custody monitoring closeout seal receipt API errors without local fallback", async () => {
  ...
  it("surfaces certified release final evidence index regression guardrail receipt API errors without local fallback", async () => {
    vi.spyOn(globalThis, "fetch").mockResolvedValueOnce(jsonResponse({ message: "certified release final evidence index regression guardrail receipt unavailable" }, 503));

    await expect(getProviderWebhookReviewQaHandoffCertifiedReleaseFinalEvidenceIndexRegressionGuardrailReceipt()).rejects.toThrow("API request failed (503): certified release final evidence index regression guardrail receipt unavailable");
  });

  it("surfaces certified release final archive seal operational closure receipt API errors without local fallback", async () => {
    vi.spyOn(globalThis, "fetch").mockResolvedValueOnce(jsonResponse({ message: "certified release final archive seal operational closure receipt unavailable" }, 503));

    await expect(getProviderWebhookReviewQaHandoffCertifiedReleaseFinalArchiveSealOperationalClosureReceipt()).rejects.toThrow("API request failed (503): certified release final archive seal operational closure receipt unavailable");
  });
...
function providerWebhookArchiveCertifiedReleaseOperationsHandoffReadinessPacketResponse(): ProviderWebhookReviewQaHandoffCertifiedReleaseOperationsHandoffReadinessPacket {
  ...
  const operationsHandoffEvidenceRows = [
    ...
    providerWebhookCertifiedReleaseOperationsHandoffEvidenceRow("no_execution_evidence_confirmed", "No-execution evidence confirmed", noExecutionLockReceipt.noExecutionLockReceiptDigest, noExecutionLockReceipt.safeFilename, 8),
