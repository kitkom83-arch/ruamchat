...
function safeProviderReadiness(readiness) {
  ...
  return !/line-test-recipient|telegram-test-chat|messenger-test-recipient|instagram-test-recipient|fb-user-|ig-user-|U-sprint|replyToken|messaging|events|rawPayload|providerRaw|payloadJson/i.test(serialized);
}
