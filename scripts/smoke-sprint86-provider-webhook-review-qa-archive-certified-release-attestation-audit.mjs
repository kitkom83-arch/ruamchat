...
async function main() {
  ...
  const sprint86Source = {
    ...
    providerService: [
      ...
      sourceSlice(providerService, "function assertQaHandoffArchiveReleaseAttestationAuditReady", "function assertQaHandoffArchiveReleaseAttestationReconciliationReady")
    ].join("\n"),
